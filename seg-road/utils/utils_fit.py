...
import torch
from nets.segformer_training import (CE_Loss, Dice_loss, Focal_Loss,ConLoss,
                                     weights_init)
    ...
    for iteration, batch in enumerate(gen):
        ...
        with torch.no_grad():
            ...
            if cuda:
                ...
                con_1 = con_1.cuda(local_rank)
                con_3 = con_3.cuda(local_rank)
        ...
        if not fp16:
            ...
            #   前向传播
            #----------------------#
            outputs,r1,r3 = model_train(imgs)
            #----------------------#
            #   计算损失
            #----------------------#
            if focal_loss:
